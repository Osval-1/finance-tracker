    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
          ...
          >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Are you sure you want to archive this budget? It will be moved
                  to archived budgets and won't appear in your active budget
                  list.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold capitalize">{budget.period}</div>
