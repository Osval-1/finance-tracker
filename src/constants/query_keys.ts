...
export const GOALS_QUERY_KEY = GOALS_QUERY_KEYS.all;
export const CATEGORIES_QUERY_KEY = TRANSACTIONS_QUERY_KEYS.categories;
export const REPORTS_QUERY_KEY = REPORTS_QUERY_KEYS.all;
export const EXCHANGE_RATES_QUERY_KEY = ["exchange-rates"] as const;
export const PLAID_QUERY_KEY = ACCOUNTS_QUERY_KEYS.plaidToken;
export const AUTH_QUERY_KEY = AUTH_QUERY_KEYS.user;
